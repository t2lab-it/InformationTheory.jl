...
MI_ksg = InformationTheory.mutual(InformationTheory.MutualInformation.KSG(), x_data, y_data)
...
MI_joint_ksg = InformationTheory.mutual(InformationTheory.MutualInformation.KSG(), x_data, (y_data, z_data))
...
MI_ksg_custom = InformationTheory.mutual(InformationTheory.MutualInformation.KSG(k=10), x_data, y_data)
...
# Reference
MI_ref = InformationTheory.shannon(InformationTheory.ShannonEntropy.KSG(), x_data) + InformationTheory.shannon(InformationTheory.ShannonEntropy.KSG(), y_data) - InformationTheory.shannon(InformationTheory.ShannonEntropy.KSG(), x_data, y_data)
