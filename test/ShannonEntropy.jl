...
hx_hist = InformationTheory.shannon(InformationTheory.ShannonEntropy.Hist(), x_data)
...
hxy_hist = InformationTheory.shannon(InformationTheory.ShannonEntropy.Hist(), x_data, y_data)
...
hxy_hist_bins = InformationTheory.shannon(InformationTheory.ShannonEntropy.Hist(bins=([-4:0.25:4;],-5:0.25:5)), x_data, y_data)
...
hx_ksg = InformationTheory.shannon(InformationTheory.ShannonEntropy.KSG(), x_data)
...
hxy_ksg = InformationTheory.shannon(InformationTheory.ShannonEntropy.KSG(), x_data, y_data)
...
hxy_ksg_custom = InformationTheory.shannon(InformationTheory.ShannonEntropy.KSG(k=10), x_data, y_data)
