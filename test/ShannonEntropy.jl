...
hx_ksg = InformationTheory.shannon(InformationTheory.KSG(), x_data)
...
hxy_ksg = InformationTheory.shannon(InformationTheory.KSG(), x_data, y_data)
...
hxy_ksg_custom = InformationTheory.shannon(InformationTheory.KSG(k=10), x_data, y_data)
