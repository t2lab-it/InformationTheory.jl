...
CMI_hist = c_mutual(ConditionalMutualInformation.Hist(), x_data, y_data₁, z_data)
...
CMI_knn = c_mutual(ConditionalMutualInformation.kNN(), x_data, y_data₁, z_data)
...
# Reference
H_xz = shannon(ShannonEntropy.KSG(), x_data, z_data)
H_yz = shannon(ShannonEntropy.KSG(), y_data₁, z_data)
H_z = shannon(ShannonEntropy.KSG(), z_data)
H_xyz = shannon(ShannonEntropy.KSG(), x_data, y_data₁, z_data)
